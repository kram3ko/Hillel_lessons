...
class Car:
    ...
    def __init__(self, model_name, production, company, engine, colour, price):
    ...
    def full_info(self):
        print(f" Model: {self.model_name}, year product: {self.production}, Who made: {self.company}, "
              ...
              f"extra_arr_class engine-power: {self.engine_power} and engine-type: {self.engine_type}")
...
# UNCOMENT THINGS down and try use some functions! Works only with class CARS!!!
